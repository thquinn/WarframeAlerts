...
namespace WarframeAlerts
{
    public class Reward
    {
        ...
        public static string[] MODS = new string[] { "Accelerated Blast", "Animal Instinct", "Armored Agility", "Blaze", "Chilling Reload", "Constitution", "Drifting Contact", "Focus Energy", "Fortitude", "Hammer Shot", "Ice Storm", "Lethal Torrent", "Rending Strike", "Shred", "Streamlined Form", "Stunning Speed", "Vigor", "Wildfire" };
